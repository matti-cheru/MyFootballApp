...
<html>
    ...
    <body>
                            ...
                            @if($_SESSION["role"] === "registered_player")
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMyReservations">
                                        ...
                                        <li><a class="dropdown-item" href="{{ route('users.myReservations', ['id' => $_SESSION['loggedID']]) }}">Le mie Prenotazioni Effettuate</a></li>
                                    </ul>
                                </li>
                            @endif
        ...
        {{-- Footer in fondo --}}
        <footer class="footer py-1 bg-dark text-white">
                ...
                <div class="modal-content">
                    <div class="modal-header bg-success text-white">
                        <h5 class="modal-title" id="successModalLabel">
                            <i class="bi bi-check-circle-fill"></i> Successo!
                        </h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body text-center">
                        <p id="successModalMessage" class="fw-bold fs-5"></p>
                    </div>
                ...
                <div class="modal-content">
                    <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title" id="errorModalLabel">
                            <i class="bi bi-x-circle-fill"></i> Eliminata!
                        </h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body text-center">
                        <p id="errorModalMessage" class="fw-bold fs-5"></p>
                    </div>
                    <div class="modal-footer">
        ...
        <script>
            $(document).ready(function() {
                ...
                if (successMessage) {
                    $('#successModalMessage').text(successMessage);
